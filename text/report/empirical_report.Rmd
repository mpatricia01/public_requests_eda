...
TABLE/FIGURE(S) describe the public universities in our data collection sample. A majority of the universities are master's or doctoral universities and located in urban areas. FIGURES/TABLES TO CREATE:
...
Our analysis on the characteristics of prospects purchased by universities includes 388 orders resulting in 1,967,352 prospects. Figure X shows the total number of prospects by domestic versus international status. Of the nearly 2 Million prospects purchased, 95% of them were domestic students. 
...
Nearly 100,000 of the 2 Million prospects purchased were international students. Figure X presents the countries from which these prospects were purchased, with XYZ representing the total number of prospects purchased by country. The top ten countries, which account for more than 60% of international prospects purchased across the 388 orders, include India (18%), China (10%), Singapore (6%), South Korea (6%), Canada (5%), United Arab Emirates (5%), Pakistan (4%), Taiwan (3%), Saudi Arabia (3%), and Thailand (3%).
...
Lastly, table X shows the difference in proportions of prospects that attend public versus private schools does not change significantly across filters used. For example, orders that specify a CBSA result in student lists where on average 14% of prospects attend private schools, which is the maximum proportion across all filters. In comparison, orders that use race/ethnicity or state filters result in students lists with the minimum proportion of prospects attending private schools (7%).


### Prospect Characteristics Across Combinations of Filters

We begin analyzing the characteristics of prospects across some of the most common combination of filters. Many of the orders in our analysis filtered by high school graduation class, zip code, PSAT scores, GPA, and zip code. Based on our analyses above, orders using this combination of filters were made by master's universities to identify in-state prospects. We "zoom" into orders by one of these master's universities in order analyze in-depth patterns in the racial and economic characteristics of prospects that result from this combination of filters. 

A master's university located in Texas made 65 orders using graduation class, PSAT scores, GPA, and zip code. These orders targeted 2019-2022 high school graduating classes with minimum PSAT scores ranging from 920-1300 and maximum SAT scores ranging from 970-1450. The university also filtered for prospects with GPAs ranging from a low of C+ to a high of A+. Lastly, prospects were also filtered using a series of 3-digit zip codes that included both in-state and neighboring state zip codes. 
...
We compare the average racial and economic characteristics of prospects in comparison to the population of 15-19 year-olds in their home zip code. For example, the three-digit zipcode 712 includes communities across the core Dallas metropolitan areas (see Figure X). This zip code was included in 13 of the 65 orders that filtered across graduation class, PSAT scores, GPA, and zip. The student lists for these orders resulted in prospects from 712 zip codes that were 76% White, 5% Latinx, 9% Black, 4% Asian, and 4% multiracial. In comparison, the population of 15-19 year olds in these zip codes are 62% White, 3% Hispanic, 32% Black, less than 1% Asian, and 2% multiracial.

Figure X present the average percentage point difference between the racial/ethnic composition of students lists and of the 15-19 year old population across all zip codes filtered by the master's university in this analysis. For example, Zip Code 712 in Figure X shows a 12 percentage point difference between White prospects purchased living in the zip code and the overall percentage of White 15-19 year olds living in the zip code (76%- 62% = 14 percentage points). Similarly, the figure shows a -23 percentage point difference between the Black prospects purchased from the zip code and the percentage of Black 15-19 year olds living in the zip code (9% - 32% = -23 percentage points).

Overall, prospects from orders that filtered using graduation class, PSAT scores, GPA, and zip code tend to be more White and Asian and less Black and Latinx than the population of 15-19 year olds from zip codes filtered by. The overepresentation of White prospects in comparison to zip code populations ranged from 2-36 percentage points for 11 of the 23 zip codes filtered by, whereas three zip codes had proportional representation (0 percetage point difference). The remaining 9 zip codes had an underrepresentation of White prospects, where eight orders ranged from -1 to -6 percentage points and one order had -21 percentage points. 


Across nearly all in-state zip codes, prospects purchased tend to be proportionall  IN COMPARISON TO ZIP CODES FILTERED [Proportionally White and Latino, but More Asian and Consistently Less Black.] For orders that filtered by high school graduation class, zip code, PSAT scores, and GPA, the resulting lists were 43% White, 27% Latinx, 13% Asian, 8% Black, 1% Native American, and 4% multiracial. Orders that filtered by high school graduation class, zip code, SAT scores, and GPA percentages resulted in similar percentages.

COMPARE TO THREE DIGIT ZIPS. 
