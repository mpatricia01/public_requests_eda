...
We begin analyzing the characteristics of prospects across the most common combination of filters.  Figure X presents the average racial and economic characteristics across two most common combinations of filters. For orders that filtered by high school graduation class, zip code, PSAT scores, and GPA, the resulting lists 
