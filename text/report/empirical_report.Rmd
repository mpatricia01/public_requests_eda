...
grid.arrange(
  arrangeGrob(grid::rasterGrob(png::readPNG(file.path(maps_dir, 'segment_ny.png'))), top = ggpubr::text_grob('New York-Newark-Jersey City, NY-NJ-PA', size = 7, face = 'bold'), padding = unit(c(0, 0, -50, 0), 'pt')),
  arrangeGrob(grid::rasterGrob(png::readPNG(file.path(maps_dir, 'segment_la.png'))), top = ggpubr::text_grob('Los Angeles-Long Beach-Anaheim, CA', size = 7, face = 'bold'), padding = unit(c(0, 0, -50, 0), 'pt')),
  arrangeGrob(grid::rasterGrob(png::readPNG(file.path(maps_dir, 'segment_philly.png'))), top = ggpubr::text_grob('Philadelphia-Camden-Wilmington, PA-NJ-DE-MD', size = 7, face = 'bold'), padding = unit(c(-50, 0, -50, 0), 'pt')),
  arrangeGrob(grid::rasterGrob(png::readPNG(file.path(maps_dir, 'segment_dc.png'))), top = ggpubr::text_grob('Washington-Arlington-Alexandria, DC-VA-MD-WV', size = 7, face = 'bold'), padding = unit(c(-50, 0, -50, 0), 'pt')),
  arrangeGrob(grid::rasterGrob(png::readPNG(file.path(maps_dir, 'legend_race.png'))), top = '', padding = unit(c(-50, 0, -50, 0), 'pt')),
  layout_matrix = rbind(
    c(1, 2, 5),
    c(3, 4, 5)
  ),
