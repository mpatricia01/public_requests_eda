...
We begin analyzing the characteristics of prospects across the most common combination of filters.  Figure X presents the average racial and economic characteristics across two most common combinations of filters. For orders that filtered by high school graduation class, zip code, PSAT scores, and GPA, the resulting lists were 43% White, 27% Latinx, 13% Asian, 8% Black, 1% Native American, and 4% multiracial. Orders that filtered by high school graduation class, zip code, SAT scores, and GPA percentages resulted in similar percentages.
