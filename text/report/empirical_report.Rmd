...
Research question 2 asks, what are the characteristics of prospects included in student lists purchased? The ma/doctoral universities in our sample primarily purchased in-state prospects. Across all ma/doctoral universities, in-state prospects were `r rq2_race_regional_instate[['white']]`% white, `r rq2_race_regional_instate[['Asian']]`% Asian, `r rq2_race_regional_instate[['Hispanic/Latino']]`% Latinx, and `r rq2_race_regional_instate[['Black/African American']]`% Black. In-state prospects by research universities were `r rq2_race_research_instate[['white']]`% white, `r rq2_race_research_instate[['Asian']]`% Asian, `r rq2_race_research_instate[['Hispanic/Latino']]`% Latinx, and `r rq2_race_research_instate[['Black/African American']]`% Black. Similar to our analysis of off-campus recruiting visits [@RN4758], research universities in our sample purchased many more out-of-state prospects than in-state prospects. These out-of-state prospects were more affluent than in-state prospects and were more likely to identify as white and Asian than in-state prospects, and were somewhat more likely to attend a private school than in-state prospects.
