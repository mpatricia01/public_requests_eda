...
Figure X also shows the number of domestic prospects purchased by in-state versus out-of-state and by institutional type. Overall, the majority of prospects purchased across all orders by all institutions in the study were in-state students (58%). However, the percent of in-state versus out-of-state prospects varied across institutional type. Research universities purchased more students overall and a greater proportion of out-of-state students than regional universities. For example, research universities in the study purchased more than 1.2 Million prospects of which 62% were out-of-state. In comparison, regional universities purchased less than 650,000 prospects of which only 4% were out-of-state students. 
...
This disparity is also likely driven by several differences across purchases by research versus regional universities. For example, out-of-state prospects purchased by research universities live in areas where the average median household income is \$101,000, whereas in-state prospects purchased live in areas with a \$91,000. However, the opposite pattern is evident for purchases by regional universities. Out-of-state prospects purchased by regional universities on average live in less affluent areas (\$69,000 median household income) than in-state prospects ($84,000 median household income). 
